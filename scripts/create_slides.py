...
SLIDES = [
    ...
    SlideSpec(
        ...
        bullets=[
            "Best balanced: IoU 0.5956, F1 0.7394, recall 0.8203",
            "High-precision mode: precision 0.8711 at threshold 0.91",
            "Baseline F1 improved from 0.6278 to 0.7394",
            "Fine-tuned with BCE + Dice + IoU loss",
        ],
        accent="7C3AED",
