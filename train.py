...
def main() -> None:
    ...
    for epoch in range(start_epoch, args.epochs + 1):
        train_metrics = run_epoch(model, train_loader, device, optimizer=optimizer, threshold=args.threshold)
        val_metrics = run_epoch(model, val_loader, device, optimizer=None, threshold=args.threshold)
